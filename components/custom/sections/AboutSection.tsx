      ...
      <div className="max-w-6xl mx-auto w-full z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 w-full items-stretch">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            {/* coding metrics */}
            <FadeIn delay={0.2} className="p-8 sm:p-10 bg-white dark:bg-[#121311] border border-[#0e0f0c]/5 dark:border-white/5 rounded-[24px] shadow-sm transition-all hover:shadow-xl">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            {/* Education Card */}
            <FadeIn delay={0.3} className="p-8 sm:p-10 bg-white dark:bg-[#121311] border border-[#0e0f0c]/5 dark:border-white/5 rounded-[24px] shadow-sm transition-all hover:shadow-xl">
              <div className="flex items-center gap-3 mb-8">
            ...
            {/* Achievements Card */}
            <FadeIn delay={0.4} className="p-8 sm:p-10 bg-white dark:bg-[#121311] border border-[#0e0f0c]/5 dark:border-white/5 rounded-[24px] flex-1 shadow-sm transition-all hover:shadow-xl">
              <div className="flex items-center gap-3 mb-8">
